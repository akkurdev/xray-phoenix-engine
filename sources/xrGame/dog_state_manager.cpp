...
#include "group_state_hear_danger_sound.h"
...
bool CStateManagerDog::check_eat() { return (!object->CorpseMan.get_corpse() && !object->EatedCorpse) ? false : inherited::check_state(eStateEat); }
