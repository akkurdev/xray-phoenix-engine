...
void CCar::SCarSound::Init()
{
    ...
    if (ini->section_exist("car_sound") && ini->line_exist("car_sound", "snd_volume"))
    {
        ...
        snd_engine.create(ini->r_string("car_sound", "snd_name"), SoundType::Effect, sg_SourceType); //
        snd_engine_start.create(READ_IF_EXISTS(ini, r_string, "car_sound", "engine_start", "car\\test_car_start"), SoundType::Effect, sg_SourceType);
        snd_engine_stop.create(READ_IF_EXISTS(ini, r_string, "car_sound", "engine_stop", "car\\test_car_stop"), SoundType::Effect, sg_SourceType);
        ...
        {
            snd_transmission.create(ini->r_string("car_sound", "transmission_switch"), SoundType::Effect, sg_SourceType);
        }
    }
    else
    {
