...
CUIStatic::~CUIStatic() { xr_delete(m_pLines); }
...
void CUIStatic::SetClrAnimDelay(float delay) { m_lanim_clr.m_lanim_delay_time = delay; }
...
void CUIStatic::ClipperOff() { ClipperOff(m_UIStaticItem); }
...
void CUIStatic::SetClipRect(Frect r) { m_ClipRect = r; }
...
bool CUIStatic::IsHighlightText() { return m_bCursorOverWindow; }
