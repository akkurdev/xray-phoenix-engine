...
int CScriptGameObject::GetGoodwill(CScriptGameObject* pToWho)
{
    ...
    return RelationSystem::Instance().Executor()->PersonalGoodwill()->Get(pInventoryOwner->object_id(), pToWho->object().ID());
}
...
void CScriptGameObject::SetGoodwill(int goodwill, CScriptGameObject* pWhoToSet)
{
    ...
    return RelationSystem::Instance().Executor()->PersonalGoodwill()->Set(pInventoryOwner->object_id(), pWhoToSet->object().ID(), goodwill);
}
...
void CScriptGameObject::ChangeGoodwill(int delta_goodwill, CScriptGameObject* pWhoToSet)
{
    ...
    RelationSystem::Instance().Executor()->PersonalGoodwill()->Change(pInventoryOwner->object_id(), pWhoToSet->object().ID(), delta_goodwill);
}
...
void CScriptGameObject::SetRelation(ALife::ERelationType relation, CScriptGameObject* pWhoToSet)
{
    ...
    RelationSystem::Instance().Executor()->RelationType()->SetTotalRelationType(pInventoryOwner, pOthersInventoryOwner, relation);
}
...
int CScriptGameObject::GetAttitude(CScriptGameObject* pToWho)
{
    ...
    VERIFY(pOthersInventoryOwner);
    return RelationSystem::Instance().Executor()->RelationType()->GetTotalRelationAmount(pInventoryOwner, pOthersInventoryOwner);
}
