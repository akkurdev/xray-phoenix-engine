...
void CCustomZone::Load(LPCSTR section)
{
    ...
    if (m_zone_flags.test(eSpawnBlowoutArtefacts))
    {
        ...
        if (pSettings->line_exist(section, "artefact_born_sound"))
        {
            ...
            m_ArtefactBornSound.create(sound_str, SoundType::Effect, sg_SourceType);
        }
