...
void CPolterTele::load(LPCSTR section)
{
    ...
    ::Sound->create(m_sound_tele_hold, pSettings->r_string(section, "sound_tele_hold"), SoundType::Effect, SOUND_TYPE_WORLD);
    ::Sound->create(m_sound_tele_throw, pSettings->r_string(section, "sound_tele_throw"), SoundType::Effect, SOUND_TYPE_WORLD);
