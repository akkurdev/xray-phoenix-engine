...
void CMonsterSquadManager::remove_member(u8 team_id, u8 squad_id, u8 group_id, CEntity* e) { get_squad(team_id, squad_id, group_id)->RemoveMember(e); }
...
CMonsterSquad* CMonsterSquadManager::get_squad(const CEntity* entity) { return get_squad((u8)entity->g_Team(), (u8)entity->g_Squad(), (u8)entity->g_Group()); }
