...
void CPoltergeist::update_detection()
{
    ...
    if (!get_actor_ignore() && time_passed_sec > 0.f && time_passed_sec < 2.f && dist2actor < get_detection_far_range())
    {
        ...
        float const range_factor = relative_range * get_detection_far_range_factor() + (1.f - relative_range) * get_detection_near_range_factor();
...
float CPoltergeist::get_detection_near_range_factor() { return m_detection_near_range_factor; }

float CPoltergeist::get_detection_far_range_factor() { return m_detection_far_range_factor; }

float CPoltergeist::get_detection_speed_factor() { return m_detection_speed_factor; }

float CPoltergeist::get_detection_loose_speed() { return m_detection_loose_speed; }

float CPoltergeist::get_detection_far_range() { return m_detection_far_range; }

float CPoltergeist::get_detection_success_level() { return m_detection_success_level; }
