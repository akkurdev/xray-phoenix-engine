...
CPPEffectorControllerAura::CPPEffectorControllerAura(const SPPInfo& ppi, u32 time_to_fade, const ref_sound& snd_left, const ref_sound& snd_right) : inherited(ppi)
{
    ...
    m_snd_left.clone(snd_left, SoundType::Effect, sg_SourceType);
    m_snd_right.clone(snd_right, SoundType::Effect, sg_SourceType);
...
void CControllerAura::load(LPCSTR section)
{
    ...
    aura_sound.left.create(pSettings->r_string(section, "PsyAura_SoundLeftPath"), SoundType::Effect, sg_SourceType);
    aura_sound.right.create(pSettings->r_string(section, "PsyAura_SoundRightPath"), SoundType::Effect, sg_SourceType);
