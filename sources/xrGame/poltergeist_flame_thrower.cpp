...
void CPolterFlame::load(LPCSTR section)
{
    ...
    m_sound.create(pSettings->r_string(section, "flame_sound"), SoundType::Effect, SOUND_TYPE_WORLD);
    ...
    m_scan_sound.create(pSettings->r_string(section, "flame_scan_sound"), SoundType::Effect, SOUND_TYPE_WORLD);
    //-----------------------------------------------------------------------------------------
...
void CPolterFlame::create_flame(const CObject* target_object)
{
    ...
    element->sound.clone(m_sound, SoundType::Effect, SOUND_TYPE_WORLD);
