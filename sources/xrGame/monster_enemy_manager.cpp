...
bool CMonsterEnemyManager::see_enemy_now(const CEntityAlive* enemy) { return monster->memory().visual().visible_right_now(enemy); }

bool CMonsterEnemyManager::see_enemy_recently() { return see_enemy_recently(enemy); }

bool CMonsterEnemyManager::see_enemy_recently(const CEntityAlive* enemy) { return monster->memory().visual().visible_now(enemy); }
