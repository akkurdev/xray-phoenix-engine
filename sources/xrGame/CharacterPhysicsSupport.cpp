...
//////////////////////this needs to evaluate object box//////////////////////////////////////////////////////
    ...
    if (anim_mov_ctrl && anim_mov_blend && anim_mov_blend->blend_state() != CBlend::eFREE_SLOT &&
        anim_mov_blend->timeCurrent + Device.fTimeDelta * anim_mov_blend->speed < anim_mov_blend->timeTotal - SAMPLE_SPF - EPS) //.
    {
