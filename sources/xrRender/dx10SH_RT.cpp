...
void CRT::reset_end() { create(*cName, dwWidth, dwHeight, fmt, false); }

#ifdef USE_DX11
void resptrcode_crt::create(LPCSTR Name, u32 w, u32 h, D3DFORMAT f, u32 SampleCount, bool useUAV) { _set(DEV->_CreateRT(Name, w, h, f, SampleCount, useUAV)); }
#else
