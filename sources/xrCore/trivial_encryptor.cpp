...
void trivial_encryptor::encode(pcvoid source, const u32& source_size, pvoid destination, key_flag what)
{
...
void trivial_encryptor::decode(pcvoid source, const u32& source_size, pvoid destination, key_flag what)
{
    if (what != m_current_key)
    {
        initialize(what);
